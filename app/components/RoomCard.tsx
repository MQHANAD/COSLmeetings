  ...
  return (
    <div
      className={`card bg-base-100 shadow-sm ${
        isUnavailable ? 'opacity-50' : 'bg-white rounded-lg shadow-md overflow-hidden cursor-pointer transform transition duration-300 ease-in-out hover:shadow-lg active:scale-95'
      }`}
    >
      <figure>
